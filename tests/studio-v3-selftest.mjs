...
const vp8=render.indexOf("video/webm;codecs=vp8,opus"),mp4=render.indexOf("video/mp4;codecs=avc1.42E01E,mp4a.40.2");assert.ok(vp8>=0&&mp4>=0&&vp8<mp4,'non-Safari recorder preference must put VP8/WebM before MP4/H.264');

...
export async function smokeVusicLogin(env){
  ...
  try{
    ...
    await page.goto(env.VUSIC_LOGIN_URL||'https://vusicstudio.com/?login=true',{waitUntil:'networkidle2',timeout:45000});
    ...
    await page.goto(env.VUSIC_NEW_RELEASE_URL||'https://vusicstudio.com/song-release',{waitUntil:'networkidle2',timeout:45000}).catch(()=>{});
    ...
    return {ok:releaseAccessible,authenticated:true,releaseAccessible,url:releaseUrl,browserBinding:status.browserBinding};
